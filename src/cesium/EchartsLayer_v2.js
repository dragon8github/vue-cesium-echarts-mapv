...
export default class EchartsglLayer {
    ...
    createLayer() {
        ...
        handler.setInputAction(click => mockClickChart(event, this.chart), Cesium.ScreenSpaceEventType.LEFT_CLICK)
    }
    ...
    getE3CoordinateSystem(viewer) {
        var CoordSystem = function(viewer) {
            this._viewer = viewer
            this._mapOffset = [0, 0]
        }
